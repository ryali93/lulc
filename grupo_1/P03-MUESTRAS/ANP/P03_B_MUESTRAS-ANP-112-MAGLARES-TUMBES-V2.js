...
var remap_8_17 = 
    ...
    ee.FeatureCollection(
        [ee.Feature(
            ee.Geometry.Polygon(
                [[[-80.35151034034162, -3.4664724792459225],
                  [-80.30928164161115, -3.4969718049156504],
                  [-80.27082949317365, -3.5024547247959403],
                  [-80.2186444345799, -3.4702421122630747],
                  [-80.20594149268537, -3.427747200375886],
                  [-80.28799563086896, -3.3979310935441633],
                  [-80.3221562163651, -3.3747973802587894],
                  [-80.32404452002912, -3.4010155612491757],
                  [-80.34842043555646, -3.4575623778766427]]]),
            {
              "original": "7,16,18",
              "new": "4,15,15",
              "system:index": "0"
...
// las muestra de clase 1 se toman solo donde hay cohencidencia entre worldCover y la geometrias dibujadas
updtReference = clasificacion_v1.where(clasificacion_v1.eq(1),0)
