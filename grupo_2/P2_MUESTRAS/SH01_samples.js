var c28_pajonal = /* color: #d63000 */ee.FeatureCollection(
        [ee.Feature(
            ee.Geometry.Polygon(
    ...
    c12_bofedal = /* color: #98ff00 */ee.FeatureCollection(
        [ee.Feature(
            ee.Geometry.Polygon(
    ...
    c01_area_urbana = /* color: #0b4a8b */ee.FeatureCollection(
        [ee.Feature(
            ee.Geometry.Polygon(
    ...
    c26_afloramiento_rocoso = /* color: #d6d2ae */ee.FeatureCollection(
        [ee.Feature(
            ee.Geometry.Polygon(
    ...
    c02_mineria = /* color: #293dff */ee.FeatureCollection(
        [ee.Feature(
            ee.Geometry.Polygon(
    ...
    c02_mineria_9 = /* color: #bf39d2 */ee.FeatureCollection(
        [ee.Feature(
            ee.Geometry.Polygon(
    ...
    c29_pasto = /* color: #00ffff */ee.FeatureCollection(
        [ee.Feature(
            ee.Geometry.Polygon(
...
var fcDict = {
  ...
  c02_mineria_9: c02_mineria_9,
  c29_pasto: c29_pasto
};

// === Generar colección final de samples ===
var sh01_samples = samplesUtils.generarSamples(ANP, fcDict);
print("✅ Muestras generadas SH01:", sh01_samples, sh01_samples.size());

// === Exportar para ser consumido en clasificación ===
exports.SH01 = sh01_samples;
