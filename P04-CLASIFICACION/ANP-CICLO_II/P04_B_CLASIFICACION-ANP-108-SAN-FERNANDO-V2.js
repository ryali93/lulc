...
var c1_area_urbana = /* color: #ff0000 */ee.FeatureCollection(
    ...
    c21_tilasial = /* color: #7ed4d6 */ee.FeatureCollection(
        [ee.Feature(
            ee.Geometry.Point([-75.21783705730205, -15.105439685073714]),
            {
              "clase": 21,
              "system:index": "0"
            }),
        ee.Feature(
            ee.Geometry.Point([-75.21165724773174, -15.108422806178245]),
            {
              "clase": 21,
              "system:index": "1"
            }),
        ee.Feature(
            ee.Geometry.Point([-75.20770903606181, -15.109914351006605]),
            {
              "clase": 21,
              "system:index": "2"
            }),
        ee.Feature(
            ee.Geometry.Point([-75.152090749929, -15.108919988952513]),
            {
              "clase": 21,
              "system:index": "3"
            }),
        ee.Feature(
            ee.Geometry.Point([-75.16668196697002, -15.112068786138806]),
            {
              "clase": 21,
              "system:index": "4"
            }),
        ee.Feature(
            ee.Geometry.Point([-75.16239043254619, -15.109748624321153]),
            {
              "clase": 21,
              "system:index": "5"
            }),
        ee.Feature(
            ee.Geometry.Point([-75.16033049602275, -15.107262708508697]),
            {
              "clase": 21,
              "system:index": "6"
            }),
        ee.Feature(
            ee.Geometry.Point([-75.18728133220439, -15.118697680088697]),
            {
              "clase": 21,
              "system:index": "7"
            }),
        ee.Feature(
            ee.Geometry.Point([-75.22504683513408, -15.09980478638552]),
            {
              "clase": 21,
              "system:index": "8"
            }),
        ee.Feature(
            ee.Geometry.Point([-75.2344882108665, -15.09201512140001]),
            {
              "clase": 21,
              "system:index": "9"
            }),
        ee.Feature(
            ee.Geometry.Point([-75.23088332195049, -15.09400399919113]),
            {
              "clase": 21,
              "system:index": "10"
            }),
        ee.Feature(
            ee.Geometry.Point([-75.22590514201885, -15.092678082732482]),
            {
              "clase": 21,
              "system:index": "11"
            }),
        ee.Feature(
            ee.Geometry.Point([-75.22504683513408, -15.074445892575381]),
            {
              "clase": 21,
              "system:index": "12"
            }),
        ee.Feature(
            ee.Geometry.Point([-75.22367354411845, -15.075771922757255]),
            {
              "clase": 21,
              "system:index": "13"
            }),
        ee.Feature(
            ee.Geometry.Point([-75.2205836393333, -15.095495645315067]),
            {
              "clase": 21,
              "system:index": "14"
            }),
        ee.Feature(
            ee.Geometry.Point([-75.22041197795635, -15.101627858208916]),
            {
              "clase": 21,
              "system:index": "15"
            }),
        ee.Feature(
            ee.Geometry.Point([-75.22178526897197, -15.108257078327984]),
            {
              "clase": 21,
              "system:index": "16"
            }),
        ee.Feature(
            ee.Geometry.Point([-75.21612044353252, -15.10958289750629]),
            {
              "clase": 21,
              "system:index": "17"
            }),
        ee.Feature(
            ee.Geometry.Point([-75.20650740642314, -15.112234511012092]),
            {
              "clase": 21,
              "system:index": "18"
            }),
        ee.Feature(
            ee.Geometry.Point([-75.21200057048564, -15.111240159830578]),
            {
              "clase": 21,
              "system:index": "19"
            })]);
...
var region = 108, // 101 - 114
    ...
    center_ANP = false,
    Descartar_muestras = [15]; // descartar muestras automaticas;
//---------------------------------
